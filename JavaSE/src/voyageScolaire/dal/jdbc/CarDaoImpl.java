...
public class CarDaoImpl implements CarDao {
    ...
    public void insert(Article article) throws VoyageDalException {
        try (Connection cnx = JdbcTools.getConnection()) {
            ...
            e.printStackTrace();
            throw new VoyageDalException("problème dans l'insertion d'un article");
        }
    }

    public List<Article> selectAll() throws VoyageDalException {
        ...
        try (Connection cnx = JdbcTools.getConnection()) {
            ...
            e.printStackTrace();
            throw new VoyageDalException("problème dans la selection des Articles");
        }
        return result;
    }

    public Article selectById(int id) throws VoyageDalException {
        ...
        try (Connection cnx = JdbcTools.getConnection()) {
            ...
            e.printStackTrace();
            throw new VoyageDalException("Problème dans la sélection d'article");
        }
        return art;
    }

    public void update(Article article) throws VoyageDalException {
        try (Connection cnx = JdbcTools.getConnection()) {
            ...
            e.printStackTrace();
            throw new VoyageDalException("Problème dans la modification");
        }
    }

    public void delete(int idArticle) throws VoyageDalException {
        try (Connection cnx = JdbcTools.getConnection()) {
            PreparedStatement stmt = cnx.prepareStatement(DELETE);
            stmt.setInt(1, idArticle);
            stmt.executeUpdate();
        } catch (Exception e) {
            throw new VoyageDalException("Problème lors de la suppression");
        }
    }
